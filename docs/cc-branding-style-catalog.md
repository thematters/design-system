# CC & Branding 風格分類 Catalog

生成時間：2026-05-05T03:39:11.296Z
來源：[CC & Branding](https://www.figma.com/design/HQ5Y6bBc9dVDT99u8Qvkb5/CC---Branding)

這份 catalog 將 Figma 既有宣傳設計依活動分類整理成 Matters Studio 可讀的版型、底圖、文字與輸出尺寸規則。
...
給初次使用 Matters 宣傳模板的人，理解尺寸、文字安全區、logo 與輸出流程。

- 產品線：Shared
- Studio 可產品化程度：reference
- 版型家族：待補
...
- 字型：Noto Sans 500 (6), Noto Sans 600 (6)
- 字級：40px (10), 96px (2)
- 文字樣本：
  - 文字：直接調整 圖片：點選圖片（多點幾下可以點中他），然後在視窗右邊工具欄 Fill > Image 點擊圖，出現小彈窗後，滑鼠移到圖片上會出現Choose i
  - 可否調整字級？或刪減圖案？
  - 我如果誤刪檔案該怎麼辦？
  - 排版可以調整嗎？
  - 我沒有編輯權限？
...
- 新手指南本身不出圖，應變成 Studio onboarding 與欄位提示。

OpenAI Image 2 初始 prompt：
...
站內發文、公告、社媒推播、cover、newsletter banner、blog cover。

- 產品線：Matters.Town
- Studio 可產品化程度：medium
- 版型家族：square-social-card, site-cover-16-9, newsletter-banner, announcement-strip
...
- 圖片填色：1
- 漸層填色：0
- 常見色彩：#129D87 (55), #F6DE7D (50), #FFFFFF (50), #C7E5E4 (32), #00A68E (27), #FFB6B6 (26), #E2C15A (15), #65C4B2 (14)
...
- 產品線：Matters.Town
- Studio 可產品化程度：high
- 版型家族：quote-square, image-quote-square, multi-image-post
...
- 圖片填色：7
- 漸層填色：11
- 常見色彩：#FFFFFF (12), #FECB63 (6), #333333 (5), #B48629 (4), #F6F5F1/50% (2), #00292C/60% (1), #214538/60% (1), #C0A46B (1)
...
- 字型：Noto Serif TC 500 (8), Noto Serif TC 700 (7), Noto Serif TC 400 (4), Noto Sans TC 400 (3), Noto Serif TC 600 (2), Noto Sans 400 (1)
- 字級：24px (7), 28px (7), 20px (5), 56px (3), 32px (1), 39px (1), 44px (1)
- 文字樣本：
  - 星期一
  - － RickyWang
  - < 治理透明就沒骯髒事？從政治學看 Arbitrum DAO 第一個提案就崩壞 >
  - # 在 WEB3 創作
  - 如果投票過程不順利，那這事情就會非常嚴重，在 DAO 形式底下，你幾乎可以發現很多核心團隊都只是需要投票做個形式過個水，他們並沒有真心想到提案被否決或是如果提案
...
年度問卷、散步活動、註冊登入、遊牧者計畫、Billboard、錢包託管等 campaign。

- 產品線：Matters.Town
- Studio 可產品化程度：medium
- 版型家族：survey-carousel, campaign-square, story-vertical, product-announcement
...
- 圖片填色：11
- 漸層填色：3
- 常見色彩：#FFFFFF (16), #DADADA (8), #333333 (6), #FFF213 (5), #FFDE69 (3), #6D9AFA (2), #000000/10% (1), #0E2A6E (1)
...
- 字型：jf-jinxuan 700 (7), jf-jinxuanlatte-2.1 800 (7), jf-jinxuan 500 (2), jf-jinxuanlatte-2.1 500 (1), lihsianti 400 (1)
- 字級：60px (3), 120px (2), 80px (2), 100px (1), 20px (1), 22px (1), 25px (1), 30px (1), 35px (1), 40px (1)
- 文字樣本：
  - 迎來新一年
  - 馬特市年度問卷
  - 世界在重組，寫下你的 2025
...
研究、社群活動、Twitter Space、Weekly AMA、side event、本週活動預告。

- 產品線：Matters Lab
- Studio 可產品化程度：high
- 版型家族：event-og, speaker-poster, weekly-schedule, event-carousel
...
- 圖片填色：22
- 漸層填色：5
- 常見色彩：#FFFFFF (51), #FFE591 (22), #6CFFF4 (21), #000000 (16), #0F375B (14), #82F4F1 (4), #E195FF (4), #E2D9AC (4)
...
- 字型：Noto Sans 500 (16), Noto Sans 700 (14), jf-jinxuan 700 (9), jf-jinxuan 500 (4), Plus Jakarta Sans 400 (3), jf-jinxuan 300 (2), Noto Sans 900 (2), Open Sans 800 (1)
- 字級：24px (10), 15px (8), 32px (8), 30px (7), 40px (5), 14px (4), 16px (4), 28px (3), 64px (1), 72px (1)
- 文字樣本：
  - 11月26日（周日）
  - 15:00 - 16:00 （東八區）
  - Twitter Space https://twitter.com/i/spaces/1nAJEaXLmbXJL
  - Gitcoin Grants AMA
  - 迎戰 Gitcoin Grants 19 第五擊：手把手教學專場 （國語）
...
好文推薦、文章金句、七日書題目、講座摘要、murmur、FB cover、newsletter cover。

- 產品線：自由寫
- Studio 可產品化程度：high
- 版型家族：ig-recommendation, ig-quote, daily-prompt, lecture-summary, murmur-dialog
...
- 圖片填色：13
- 漸層填色：2
- 常見色彩：#686868 (40), #231816 (20), #F4D330 (20), #FFFFFF (19), #C16B0B (17), #333333 (7), #C28949 (5), #C9BC45 (5)
...
- 字型：creamfont-3.0 400 (25), Noto Serif TC 500 (2)
- 字級：40px (9), 30px (6), 20px (5), 51px (4), 70px (3)
- 文字樣本：
  - 天空中最黯的星
  - @
  - roseisarose
...
冬季、春季、夏季、秋季、周年慶、年度總結、問卷等成套活動物料。

- 產品線：自由寫
- Studio 可產品化程度：medium
- 版型家族：seasonal-ig-series, questionnaire-card, anniversary-campaign, summary-card
...
- 圖片填色：17
- 漸層填色：8
- 常見色彩：#000000 (47), #333333 (32), #231815 (25), #FFFFFF (25), #FFF9E9 (20), #070001 (13), #458B0E (12), #231814 (7)
...
- 字型：jf-jinxuan 500 (36), jf-jinxuan 700 (21), creamfont-3.0 400 (1)
- 字級：20px (19), 24px (12), 30px (12), 40px (6), 60px (3), 70px (2), 50px (1), 51px (1), 65px (1), 90px (1)
- 文字樣本：
  - 2025 年夏季主題
  - 六 月
  - 我的成長
  - 2025 年 1 月 14 日 開始報名
  - ・
...
七日書 logo、題目卡、月初宣傳、POAP。

- 產品線：自由寫 / 七日書
- Studio 可產品化程度：high
- 版型家族：daily-topic-square, monthly-promo-portrait, facebook-cover, poap
...
- 圖片填色：14
- 漸層填色：0
- 常見色彩：#FFFFFF (17), #808080 (9), #0F76B7 (8), #FFF70A (7), #333333 (6), #5550F6 (6), #FFEFA7 (6), #9F4FDB (5)
...
- 字型：jf-jinxuan 500 (29), jf-jinxuan 700 (15), creamfont-3.0 400 (1)
- 字級：30px (10), 32px (9), 24px (6), 120px (4), 20px (4), 220px (4), 40px (3), 70px (2), 100px (1), 35px (1)
- 文字樣本：
  - 我的職場人格
  - 每日題目
  - 關注自由寫
...
- The Space 目前樣本少，先歸入活動海報族群，保留獨立品牌欄位。

從代表樣本抽出的底圖訊號：

- 圖片填色：4
- 漸層填色：0
- 常見色彩：#FFFFFF (393), #000000 (191), #E0FEA0 (7)

### 字型與文字排版

- 先沿用 Matters Lab event hierarchy，再視後續素材補強。

從代表樣本抽出的文字訊號：

- 字型：Noto Sans 900 (6), Noto Sans 600 (3), Noto Sans 800 (2), Noto Sans HK 900 (2)
- 字級：14px (3), 24px (3), 32px (3), 20px (2), 72px (2)
- 文字樣本：
  - MtloScout
  - The Space AMA
  - 東八區 6/27 20:30
  - The Space Discord Online Campaign
  - 活動抽獎 MeloScout 10WL
