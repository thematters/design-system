...
| 品牌模板分類           | 數量 | 對應元件                                                        |
| ---------------------- | ---: | --------------------------------------------------------------- |
| 1. 好文精選推薦_IG     |   22 | （未開 spec — 推測歸屬於主 design-system feature-card 範疇）     |
| **2. 七日書題目_IG_1** | **35** | **`components/freewrite/day-prompt-card/`** ← 主源              |
| 3. 文章金句_IG         |   18 | （未開 spec — quote-card 候選元件）                              |
