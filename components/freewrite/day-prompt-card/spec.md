...
| --------------------------------- | -------: | ------------------------------------ |
| 自由寫：品牌模板（**主 mother**） |   **35** | `3902:223` "2. 七日書題目\_IG_1" 群  |
| 自由寫：Q2 七日書的模板           |       16 | `5646:2` IG*題目\_1~8 + FB*題目\_1~8 |
...
1. 抽 `3902:223` "2. 七日書題目\_IG_1" 前 5 個 frame 的：
...
3. 抽 Q2 模板 IG*題目\_1 → IG*題目\_8 8 個 → D1-D8 完整 layout 約束
